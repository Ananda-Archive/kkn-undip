    ...
    <v-layout align-center fill-height>
        <v-container fluid>
            ...
            <v-col cols="12" sm="8" md="4">
                ...
                <v-toolbar color="#C0392B" dark flat>
                ...
                <v-card-actions>
                    <v-spacer />
                    <v-btn dark color="#C0392B" class="mt-n7 mb-2 mr-1" @click="signIn">
                        <span v-if="loading">
    ...
    methods: {
        signIn() {
            ...
            firebaseApp.auth().signInWithEmailAndPassword(this.email,this.password)
                .then(() => {
                    this.$store.dispatch('mutateUid',firebaseApp.auth().currentUser.uid)
                    this.$router.push('/Dashboard')
                    this.loading = false
                })
                .catch((err) => {
